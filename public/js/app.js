...
function initAdmin(socket) {
  ...
  axios.get('/admin/orders', {
    ...
    totalPriceMarkup.innerHTML = "<h1 class=\"font-bold text-2xl mb-4 amount\"> Total:- \u20B9 ".concat(countTotalPrice, "</h1>");
  })["catch"](function (err) {
    var _console;

    /* eslint-disable */
    (_console = console).log.apply(_console, _toConsumableArray(oo_oo("3284123522_30_8_30_24_4", err)));
  });
  axios.get('/admin/orders/pricecalculation', {
    ...
    /* eslint-disable */
    (_console2 = console).log.apply(_console2, _toConsumableArray(oo_oo("3284123522_38_8_38_29_4", res.data)));
  })["catch"](function (err) {
    var _console3;

    /* eslint-disable */
    (_console3 = console).log.apply(_console3, _toConsumableArray(oo_oo("3284123522_40_8_40_24_4", err)));
  });

...
function initAdmin(socket) {
  ...
  var orderTitle = document.getElementById('orders-title');
  var orderCount = 0;
  ...
  axios.get('/admin/orders/pricecalculation', {
    ...
    var dailyTotal = res.data.dailyTotal; // Update the totalPriceMarkup element with the totals
  ...
  axios.get('/admin/orders', {
    ...
    if (orderTableBody != null) {
      ...
      orderTitle.innerText = "All Orders (".concat(orderCount, ")");
    }
  })["catch"](function (err) {
    console.log(err);
  });
  ...
  socket.on('totalOrdersAmount', function (Amount) {
    if (totalPriceMarkup) {
      totalPriceMarkup.innerHTML = "\n            <h1 class=\"font-bold text-2xl mb-2 amount\">Daily Total: \u20B9 ".concat(Amount, "</h1>");
    }
  });
}
...
updateStatus(orders); // Cart - Address Set to Hidden Input (Address input and Phone input)
...
if (form) {
  form.addEventListener('submit', function (e) {
    ...
    if (selectedAddressInput) {
      var selectedAddress = JSON.parse(selectedAddressInput.value);
      var addressLine1 = selectedAddress.addressLine1,
          addressLine2 = selectedAddress.addressLine2,
          landmark = selectedAddress.landmark,
          city = selectedAddress.city,
          postalCode = selectedAddress.postalCode,
          phone = selectedAddress.phone;
      var Address = addressLine1 + "," + addressLine2 + "," + landmark + "," + city + "-" + postalCode; // Set the Value of the Address input field

      var addressInputElement = document.getElementById('address_input');
      addressInputElement.value = Address; //Set the phone number input field

      var phoneInputElement = document.getElementById('phone_input');
      ...
      }).show(); // console.log("No address selected");
    }
  });
...
document.addEventListener('DOMContentLoaded', function () {
  var labels = [document.getElementById('label-home'), document.getElementById('label-work'), document.getElementById('label-other')].filter(Boolean);
  if (labels.length === 0) return;
  var spans = labels.map(function (l) {
    return l.querySelector('span');
  });
  var svgs = labels.map(function (l) {
    return l.querySelector('svg');
  });
  var radios = document.querySelectorAll('input[name="addressType"]'); // --- ADD THIS BLOCK: set highlight on page load ---
...
__webpack_require__(/*! F:\01_FeedMore\Feedmore\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! F:\01_FeedMore\Feedmore\resources\scss\app.scss */"./resources/scss/app.scss");
